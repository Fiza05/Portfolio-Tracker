package com.fiza.simple_portfolio_tracker.Service.Impl;
...
public class StockServiceImpl implements StockService{
	...
	public List<StockDTO> getAllStocks() {
		...
		List<StockDTO> stockDtos =allstocks.stream().map(stock ->
		this.stockToDto(stock)).collect(Collectors.toList());
		return stockDtos;
